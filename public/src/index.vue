			...
			return {
				...
				tabItems: [{
					...
					},
					{
						...
						selectedImage: '/src/view/home/images/baike-active.png',
						src: '/view/link-wiki/index/index.js',
						visibility: 'hidden',
					},
					{
						index: 2,
                    ...
                    },
                    {
                        ...
                        titleColor: '#888888',
                        icon: '',
                        image: '/src/view/home/images/user.png',
                        selectedImage: '/src/view/home/images/user-active.png',
                        src: '/view/personal/index.js',
                        visibility: 'hidden',
                    }
				],
			}
